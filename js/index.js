(function(){
    ...
    var inputCaracteres = document.getElementById('num-caracteres');
    ...
    function generarPassword(){
       ...
       caracterFinal = caracteresFinales.split(' ');

       for ( var i = 0; i < configuracion.caracteres; i++){
           password += caracterFinal[Math.floor(Math.random() * caracterFinal.length)];
       }
